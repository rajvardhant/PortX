 ...
 * 2. Enforces 10-digit numeric phone number validation.
 * 3. Enforces UPPERCASE formatting for license numbers.
 * 4. Links available commercial vehicles to drivers.
 */
@Service
...
public class DriverService {
    ...
    // Inject JPA repositories for database access
    ...
    /**
     * Creates a new Driver record after validating input data.
     */
    @Transactional
    public DriverResponse createDriver(DriverRequest req) {
        ...
        // Step 4: Build Driver entity and persist to database
